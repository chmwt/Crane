...
static const float lift_pos_maxout = 0.5f;  // 抬升电机最大速度为0.75m/s
static const float lift_pos_maxiout = 0.05f;
static const float lift_pos_alpha = 0.1f;
// 抬升电机速度环PID参数 3508
static const float lift_speed_pid_config[3] = {55.0f, 0.15f, 500.0f};
...
typedef enum
{
  upper_to_right = 0X101,
  right_to_upper = 0X103,
  lift_id = 0x202,
  y_id = 0x201,
} can_msg_id_e;
